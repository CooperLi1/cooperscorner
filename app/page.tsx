...
function ProjectsSection() {
  const projects = [
    ...
    { title: "Nudge Wristphone | 2025-Now", description: "Custom wristphone with touchscreen, vibration, buzzer. V2 of Nudge Smartwatch.", image: "/wristphonecad.png", link: "/projects/wristphone" },
