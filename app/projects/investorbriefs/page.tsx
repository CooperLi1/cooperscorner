    ...
    media: [
      {
        ...
        description: "InvestorBriefs demo video. Uses finance APIs like AlphaVantage and yfinance, as well as NewsAPI. AI using OpenAI API, graphing with ReCharts, and authentication with Clerk. ",
      },
    ],
  };
